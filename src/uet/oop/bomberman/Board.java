...
public class Board implements IRender {
    ...
    public void loadLevel(int level) {
        ...
        Clip clip = Sounds.getClip("nextLevel");
        clip.start();
        try {
    ...
    public void addPoints(int points) {
        ...
        if(this._points > this._high) this._high = this._points;
        System.out.println("+");
        System.out.println(this._points);
    }
    ...
    public int getHigh() throws IOException {
        return this._high;
    }
